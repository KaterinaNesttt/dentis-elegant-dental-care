import doctorVerhovsky from "@/assets/doctor-verhovsky.jpg";
    ...
    <section id="doctors" className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-14">
          <p className="font-body text-sm tracking-[0.3em] uppercase font-medium mb-3 text-accent">Команда</p>
          <h2 className="font-display text-4xl md:text-5xl font-bold mb-2 gold-line-center text-secondary-foreground">
            Наші лікарі
          </h2>
