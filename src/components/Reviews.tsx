    ...
    <section id="reviews" className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-14">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold gold-line-center text-secondary-foreground">
            Що кажуть пацієнти
          </h2>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div
            key={rev.name}
            className="bg-card border border-border rounded-2xl p-6 shadow-card-custom hover:shadow-md hover:-translate-y-1 transition-all duration-300 text-secondary-foreground">
