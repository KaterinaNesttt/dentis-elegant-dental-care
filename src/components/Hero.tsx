    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 pt-28 pb-20">
        <div className="max-w-2xl">
          {/* Eyebrow */}
          <p className="text-gold font-body font-medium text-sm tracking-[0.3em] uppercase mb-5 animate-fade-up">
            Преміальна стоматологія · Кропивницький
          </p>

          {/* Headline */}
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-primary-foreground leading-tight mb-6 animate-fade-up delay-100">
            Посмішка, що
            <br />
            <em className="text-gold not-italic">надихає</em>
          </h1>

          {/* Subline */}
          <p className="font-body text-primary-foreground/75 text-lg leading-relaxed max-w-lg mb-10 animate-fade-up delay-200">
