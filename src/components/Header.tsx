    ...
    <header
      ...
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <a
          ...
          className="hidden md:flex items-center gap-2 bg-gold hover:bg-gold-dark text-accent-foreground px-4 py-2 rounded-full text-lg font-body font-medium transition-all duration-200 shadow-gold-custom">
